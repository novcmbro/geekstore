  ...
  return (
    <>
      <div className="products-list-header">
        ...
        <Link to="/add-product" className="button-filled">{t("products.add-product")}</Link>
      </div>
      {isLoading ? (
          ...
          {productsList.map(product =>
            <li key={product.id} className="product-list-item">
              <div className="button-container">
                <button type="button" onClick={() => deleteProduct(product.docId)} aria-label={t("products.delete-product")}>
                ...
                <Link to={`/edit-product?id=${product.id}`} aria-label={t("products.edit-product")}>
